...
While not truly a calculator, the idea is present numbers over and over to help memorize them. Considering there are two number systems there is twice as much to learn.

## Features

Users can limit problems to problems where the sum is in the range of 1-10. This allows users to focus on those numbers specifically.
